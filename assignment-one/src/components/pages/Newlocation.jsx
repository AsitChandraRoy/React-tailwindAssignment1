        ...
        {/* <Container> */}
            <div className="grid grid-cols-12 justify-between bg-[#ffffff] py-5 px-10 mx-auto ">
                <div className='col-span-12 sm:col-span-6'>
                    <div className='flex items-center justify-start gap-3 '>
                        ...
                        <div>
                            ...
                            <h1 className='text-xl font-bold'>Tulare County,  Los Angles, CA 23415</h1>
                        </div>
                    </div>
                    ...
                    <div className='py-5 border-b'>
                        ...
                        <p className='text-[16px] text-lowLight '>Lorem ipsum dolar sit general sac mascho werhoLorem ipsum dolar sit general sac mascho werhoLorem ipsum dolar sit general sac mascho werhoLorem ipsum dolar sit general sac mascho werhoLorem ipsum dolar sit general sac mascho werhoLorem ipsum dolar sit general sac mascho werho</p>
                    </div>
                    ...
                    <div className='pt-5 border-b pb-10'>
                        ...
                        <div className='flex items-center gap-5 bg-[#f4f4f5] p-3 rounded-[10px] mt-3 hover:scale-105 transition-all duration-300 cursor-pointer'>
                            ...
                            <div className='space-y-1.5'>
                                ...
                                <p className='text-sm flex items-center'>Location name <div className='w-[4px] h-[4px] bg-[#a1a1aa] rounded-full mx-1 '></div> 16.12212, -122.1424</p>
                ...
                <div className='col-span-12 sm:col-span-6 flex flex-col items-end  '>
                    ...
                    <pre className='font-honest lg:w-[526px] tracking-tighter sm:tracking-normal text-xs sm:text-sm'>Start 19.1232, -118.233     End 19.3245, -119.2323</pre>
                </div>
