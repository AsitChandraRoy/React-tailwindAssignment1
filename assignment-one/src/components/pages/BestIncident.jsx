  ...
  return (
    <>
      {show && (
        ...
        {!isCreate && <Container className="mt-20">
            <div className="mx-auto h-auto w-[753px] flex flex-col justify-center items-start p-1 sm:p-0 ">
                ...
                <div className="grid grid-cols-12 items-center gap-1">
                    ...
                    <div key={i} className="col-span-6 sm:col-span-3 flex items-center ps-4 gap-3 bg-card w-[166px] sm:w-[180px] h-[69px] border rounded-md hover:bg-warning hover:text-white  hover:cursor-pointer hover:scale-105 transition-all duration-300 ">
                        <p className="white ">
